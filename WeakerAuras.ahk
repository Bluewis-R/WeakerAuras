...
LoadSettings(){
	...
	if(FileExist(path) = ""){
		...
		FileCopy .\settings_default.ini, .\settings.ini
		; UpdateUIFromJson()
		; SaveSettings()
		LoadSettings()
	}else{
